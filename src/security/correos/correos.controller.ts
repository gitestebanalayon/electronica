...
export class CorreosController {
  ...
  @Post('create')
  @AuthWithProfiles([Profilee.ADMIN, Profilee.DIRECTOR, Profilee.USER], { create: true })
  async create(
  ...
  @Put('delete/:id')
  @AuthWithProfiles([Profilee.ADMIN, Profilee.DIRECTOR, Profilee.USER], { delete: true })
